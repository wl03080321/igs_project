...
* **獨立公司模型**：為每家公司訓練專屬的最佳模型
* **多模型比較**：支援 7 種機器學習演算法，每家公司自動選擇最佳模型
* **未來營收預測**：使用各公司專屬模型預測未來 1-8 個季度的營收
...
### 核心技術成果
1. **獨立公司建模**：為每家公司訓練專屬模型，提高預測個性化程度
2. **多模型訓練與自動選擇**：每家公司獨立進行7種演算法比較
3. **預測營收與自動存儲**
...
- **XGBRegressor 文件**：https://xgboost.readthedocs.io/en/latest/python/python_api.html#xgboost.XGBRFRegressor
